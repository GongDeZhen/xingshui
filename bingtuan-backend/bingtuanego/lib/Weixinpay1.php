...
class Weixinpay1
{
   //const Appid = "wx267836ee1dcb2582";
   //const Mch_id = "1232486302";
...
//        $parameters["notify_url"] = 'http://api.bingtuanego.net/weixinnotify/paynotify';
       ...
       try {
           ...
           $parameters["appid"] = AP_APPID;     // 公众账号ID
...
//        $parameters["total_fee"] = 1;
    ...
    * 生成接口参数xml
    */
   public static function createRefundXml($oid,$rid,$money,$pay_id=4)
   {
       ...
       try
       {
           ...
           $parameters["mch_id"] = $parameters['op_user_id'];//商户号
